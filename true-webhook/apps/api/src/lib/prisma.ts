...
declare global {
  ...
  var __twmPrismaClient: PrismaClient | undefined;
}
...
function getDatabaseUrl(): string | undefined {
  return (
    pickEnv(['DATABASE_URL', 'DATABASE_PRIVATE_URL', 'POSTGRES_URL', 'POSTGRESQL_URL', 'RAILWAY_DATABASE_URL']) ??
...
export function getPrisma(): PrismaClient {
  ...
  if (process.env.NODE_ENV !== 'production') {
    prismaSingleton = global.__twmPrismaClient ?? client;
    global.__twmPrismaClient = prismaSingleton;
